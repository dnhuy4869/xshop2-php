<?php
    ...
    $listND = pdo_query("SELECT * FROM binhluan LIMIT $paginationStart, $limit");

    // Get total records
    $sql = pdo_query("SELECT count(id) AS id FROM binhluan");
    $allRecrods = $sql[0]['id'];
                    ...
                    <div class="card-body"> 
                        ...
                        <h4 class="card-title">Danh sách bình luận</h4>
                            ...
                            <div class="d-flex flex-row-reverse bd-highlight ">
                                <form action="index.php?tab=5&act=listBL" method="post">
                            ...
                            <tbody>
                                <?php
                                    foreach ($listND as $lh) {
                                        $deleteHref = "index.php?tab=5&act=deleteBL&id=".$lh["id"];
                                        echo '<tr>
                                                <td> '.$lh["id"].' </td>
                                                <td> '.$lh["idSanPham"].' </td>
                                                <td> '.$lh["idNguoiDung"].' </td>
                                                <td> '.$lh["ngayBinhLuan"].' </td>
                                                <td>
